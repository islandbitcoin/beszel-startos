export declare const sdk: {
    ...
    notification: {
        create: (effects: import("@start9labs/start-sdk/base/lib/Effects").Effects, options: import("@start9labs/start-sdk/base/lib/osBindings").CreateNotificationParams) => Promise<null>;
    };
    ...
    getContainerIp: (effects: import("@start9labs/start-sdk/base/lib/Effects").Effects, options?: Omit<Parameters<import("@start9labs/start-sdk/base/lib/Effects").Effects["getContainerIp"]>[0], "callback">) => import("@start9labs/start-sdk/base/lib/util").GetContainerIp;
    getStatus: (effects: import("@start9labs/start-sdk/base/lib/Effects").Effects, options?: Omit<Parameters<import("@start9labs/start-sdk/base/lib/Effects").Effects["getStatus"]>[0], "callback">) => import("@start9labs/start-sdk/base/lib/util").GetStatus;
    MultiHost: {
    ...
    Action: {
        withInput: <Id extends import("@start9labs/start-sdk/base/lib/osBindings").ActionId, InputSpecType extends import("@start9labs/start-sdk/base/lib/actions/input/builder").InputSpec<Record<string, any>>>(id: Id, metadata: import("@start9labs/start-sdk/base/lib/actions/setupActions").MaybeFn<Omit<import("@start9labs/start-sdk/base/lib/osBindings").ActionMetadata, "hasInput">>, inputSpec: import("@start9labs/start-sdk/base/lib/actions/setupActions").MaybeFn<InputSpecType, {
            effects: import("@start9labs/start-sdk/base/lib/Effects").Effects;
            prefill: unknown | null;
        }>, getInput: import("@start9labs/start-sdk/base/lib/actions/setupActions").GetInput<import("@start9labs/start-sdk/base/lib/actions/input/builder/inputSpec").ExtractInputSpecType<InputSpecType>>, run: import("@start9labs/start-sdk/base/lib/actions/setupActions").Run<import("@start9labs/start-sdk/base/lib/actions/input/builder/inputSpec").ExtractInputSpecType<InputSpecType>>) => import("@start9labs/start-sdk/base/lib/actions/setupActions").Action<Id, import("@start9labs/start-sdk/base/lib/actions/input/builder/inputSpec").ExtractInputSpecType<InputSpecType>>;
    ...
    inputSpecConstants: {
        smtpInputSpec: import("@start9labs/start-sdk/base/lib/actions/input/builder").Value<import("@start9labs/start-sdk/base/lib/actions/input/builder/variants").UnionRes<{
            ...
            custom: {
                name: string;
                spec: import("@start9labs/start-sdk/base/lib/actions/input/builder").InputSpec<{
                    provider: import("@start9labs/start-sdk/base/lib/actions/input/builder/variants").UnionRes<{
                        gmail: {
                            name: string;
                            spec: import("@start9labs/start-sdk/base/lib/actions/input/builder").InputSpec<{
                                host: string;
                                security: import("@start9labs/start-sdk/base/lib/actions/input/builder/variants").UnionRes<{
                                    tls: {
                                        name: string;
                                        spec: import("@start9labs/start-sdk/base/lib/actions/input/builder").InputSpec<{
                                            port: string;
                                ...
                                host: string;
                                security: import("@start9labs/start-sdk/base/lib/actions/input/builder/variants").UnionResStaticValidatedAs<{
                                    tls: {
                                        name: string;
                                        spec: import("@start9labs/start-sdk/base/lib/actions/input/builder").InputSpec<{
                                            port: string;
                    ...
                    provider: import("@start9labs/start-sdk/base/lib/actions/input/builder/variants").UnionResStaticValidatedAs<{
                        gmail: {
                            name: string;
                            spec: import("@start9labs/start-sdk/base/lib/actions/input/builder").InputSpec<{
                                host: string;
        ...
        systemSmtpSpec: import("@start9labs/start-sdk/base/lib/actions/input/builder").InputSpec<{
            provider: import("@start9labs/start-sdk/base/lib/actions/input/builder/variants").UnionRes<{
                gmail: {
                    name: string;
                    spec: import("@start9labs/start-sdk/base/lib/actions/input/builder").InputSpec<{
        ...
        customSmtp: import("@start9labs/start-sdk/base/lib/actions/input/builder").InputSpec<{
            host: string;
            security: import("@start9labs/start-sdk/base/lib/actions/input/builder/variants").UnionRes<{
                tls: {
                    name: string;
        ...
        smtpProviderVariants: import("@start9labs/start-sdk/base/lib/actions/input/builder").Variants<{
            gmail: {
                name: string;
                spec: import("@start9labs/start-sdk/base/lib/actions/input/builder").InputSpec<{
                    host: string;
    ...
    getOutboundGateway: <E extends import("@start9labs/start-sdk/base/lib/Effects").Effects>(effects: E) => import("@start9labs/start-sdk/base/lib/util").GetOutboundGateway;
    getSslCertificate: <E extends import("@start9labs/start-sdk/base/lib/Effects").Effects>(effects: E, hostnames: string[], algorithm?: import("@start9labs/start-sdk/base/lib/osBindings").Algorithm) => import("@start9labs/start-sdk/base/lib/util").GetSslCertificate;
    getServiceManifest: typeof import("@start9labs/start-sdk/base/lib/util").getServiceManifest;
    healthCheck: {
    ...
    trigger: {
        ...
        statusTrigger: typeof import("@start9labs/start-sdk/package/lib/trigger").statusTrigger;
    };
    Mounts: {
    ...
    Backups: {
        ...
        withPgDump: (config: import("@start9labs/start-sdk/package/lib/backup/Backups").PgDumpConfig<{
            id: "beszel";
            title: string;
            license: string;
            packageRepo: string;
            ...
            dependencies: {};
        }>) => import("@start9labs/start-sdk/package/lib/backup/Backups").Backups<{
            id: "beszel";
            title: string;
            license: string;
            packageRepo: string;
        ...
        withMysqlDump: (config: import("@start9labs/start-sdk/package/lib/backup/Backups").MysqlDumpConfig<{
            id: "beszel";
            title: string;
            license: string;
            packageRepo: string;
    ...
    InputSpec: {
        of: <Spec extends Record<string, import("@start9labs/start-sdk/base/lib/actions/input/builder").Value<any>>>(spec: Spec) => import("@start9labs/start-sdk/base/lib/actions/input/builder").InputSpec<{ [K in keyof Spec]: Spec[K] extends import("@start9labs/start-sdk/base/lib/actions/input/builder").Value<infer T extends any, any, unknown> ? T : never; }, { [K_1 in keyof Spec]: Spec[K_1] extends import("@start9labs/start-sdk/base/lib/actions/input/builder").Value<any, infer T, unknown> ? T : never; }>;
    };
    Daemon: {
